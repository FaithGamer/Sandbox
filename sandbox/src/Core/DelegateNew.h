...
namespace Sandbox
{
	...
	public:
		DelegateNew(Ret(*function)(Args...))
		{
			m_callable = makesptr<FreeFunction>(function);
		}
		template <typename... Ts>
		DelegateNew(Ret(*function)(Args...), Ts&&... args)
